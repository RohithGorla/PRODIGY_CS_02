...
def encrypt_choice():
    try:
        key = int(input("Enter encryption key (integer value): ").strip())
    except ValueError:
        print("Invalid key. Please enter an integer value.")
        encrypt_choice()
        return

    image_location = input("Enter the location or URL of the image: ").strip()
...
def decrypt_choice():
    try:
        key = int(input("Enter decryption key (integer value): ").strip())
    except ValueError:
        print("Invalid key. Please enter an integer value.")
        decrypt_choice()
        return
